...
SYSTEM_PROMPT = (
    ...
    "(con o sin punto, en mayúsculas o minúsculas, con o sin espacio antes del número):\n"
    "   - CLL / Cl / Cl. / C. / Calle -> Calle\n"
    "   - KRA / CR / CR. / Cra / Cra. / CRA / C / Car / Carrera -> Carrera\n"
    "   - TV / Tv. / Tv / Tvra / TRA / Transv / T / Transversal -> Transversal\n"
    "   - DIAG / Dg. / Dg / Diagonal -> Diagonal\n"
    "   - AV / Av. / Ave / Avenida -> Avenida\n"
    "   - CIRC / Circ. / Circ / Circular -> Circular\n"
    "   - A.K. / AK / Avenida Carrera -> Avenida Carrera\n"
    "   - CL / Cll. / Cll para 'Calle' (no confundir con Carrera)\n"
    ...
    "7. Transversal (Tv.) es un tipo de vía perpendicular a las calles y carreras; "
    "nunca lo conviertas en Calle ni en Carrera."
)
